...
import com.enjoylearning.mybatis.basic.entity.EmailSexBean;
import com.enjoylearning.mybatis.basic.entity.TJobHistory;
import com.enjoylearning.mybatis.basic.entity.TPosition;
import com.enjoylearning.mybatis.basic.entity.TUser;
import com.enjoylearning.mybatis.basic.mapper.TJobHistoryAnnoMapper;
...
public class MybatisDemo<T> {
	...
	public void testSelectIfOper() {
		...
		String email = null;
		Byte sex = 2;
 		List<TUser> list1 = mapper.selectIfOper(email, sex);
		System.out.println(list1.size());
		List<TUser> list2 = mapper.selectIfandWhereOper(email, sex);
		System.out.println(list2.size());
	}
