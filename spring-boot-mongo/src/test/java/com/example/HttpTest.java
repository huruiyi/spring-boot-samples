...
public class HttpTest {
  ...
  public void test_upload2() {
    Mono<String> resp = WebClient.create().post().uri("http://localhost:9100/upload").contentType(MediaType.MULTIPART_FORM_DATA)
        .body(BodyInserters.fromMultipartData(getFromMultipartData())).retrieve().bodyToMono(String.class);
    System.out.println("Result:" + resp.block());
  }
